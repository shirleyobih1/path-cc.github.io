...
publish: true
image_src: images/news/Anirvan-Showcase-1.png
...
<figure>
  <img src="{{ '/images/news/Anirvan-Showcase-1.png' | relative_url }}" alt="Proton-proton collision"/>
...
<figure class="figure float-right" style="margin-left: 1em">
  <img src="{{ '/images/news/Anirvan-Showcase-2.png' | relative_url }}" class="figure-img img-fluid rounded" alt="Chart">
